...
?></h3>
			...
			<span class="media-body align-self-center text-right g-color-gray-dark-v6 ">75%</span>
						...
						<i class="hs-admin-user "></i>
                                ...
                                <li class="g-brd-top g-brd-gray-light-v7 mb-0 ">
                                    <a class="d-flex align-items-center u-link-v5 g-parent g-py-15 active" href="profile_residence.php">
                ...
                <div class="col-md-9 ">
                    <div class="h-100 g-brd-around g-brd-gray-light-v7 g-rounded-4 g-pa-15 g-pa-20--md ">
                        <form enctype="multipart/form-data" method="post" class="g-pa-30 g-mb-30">
                            <header>
                                <h2 class="text-uppercase g-font-size-12 g-font-size-default--md g-color-black mb-0 ">Residential Unit Information</h2>
                            </header>
                            ...
                            <div class="row g-mb-20 ">
                                <div class="col-md-3 align-self-center g-mb-5 g-mb-0--md ">
                                    <label class="mb-0 " for="#firstName ">Household Size</label>
                                </div>
                          ...
                          <i class="hs-admin-check g-absolute-centered g-font-size-default g-color-lightblue-v3 "></i>
                                        ...
                                        <input id="username" name="gezin" class="form-control form-control-md g-color-gray-dark-v8 g-brd-gray-light-v7 g-brd-lightblue-v3--focus g-brd-lightred-v2--error g-rounded-4 g-px-20 g-py-12 " type="text " value="<?php  echo htmlspecialchars($users[0]['gezin']);?>" required="required " data-msg="This field is mandatory " data-error-class="u-has-error-v3 " data-success-class="has-success " aria-required="true ">
                                        <small class="form-text text-muted g-font-size-default g-mt-10">Please enter how many household members live in your unit.</small>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row g-mb-20 ">
                                <div class="col-md-3 align-self-center g-mb-5 g-mb-0--md ">
                                    <label class="mb-0 " for="#firstName ">Floor Area <span class="g-color-gray-light-v1"></span></label>
                                </div>
                          ...
                          <i class="hs-admin-check g-absolute-centered g-font-size-default g-color-lightblue-v3 "></i>
                                        ...
                                        <input id="username" name="oppervlakte" class="form-control form-control-md g-color-gray-dark-v8 g-brd-gray-light-v7 g-brd-lightblue-v3--focus g-brd-lightred-v2--error g-rounded-4 g-px-20 g-py-12 " type="text " value="<?php  echo htmlspecialchars($users[0]['oppervlakte']);?>" required="required " data-msg="This field is mandatory " data-error-class="u-has-error-v3 " data-success-class="has-success " aria-required="true ">
                                        <small class="form-text text-muted g-font-size-default g-mt-10">Please enter the floor area of your unit in m².</small>
                                    </div>
                                </div>
                            </div>
                          ...
                          <i class="hs-admin-check g-absolute-centered g-font-size-default g-color-lightblue-v3 "></i>
                            ...
                            <div class="row g-mb-20 ">
                                <div class="col-md-3 align-self-center g-mb-5 g-mb-0--md ">
                                    <label class="mb-0 ">I’m Administrator</label>
                                </div>
                                    ...
                                    <div class="row g-mx-minus-10 ">
                                        <div class="col-md-auto align-self-center g-width-180--md g-px-10 ">
                                            <label class="form-check-inline u-check g-mr-20 mx-0 mb-0">
                                                <input class="g-hidden-xs-up g-pos-abs g-top-0 g-right-0" name="beheerder" value="1" <?php if($users[0][ "beheerder"]==1 ) { echo 'checked=""'; } ?> type="checkbox">
                            ...
                            <div>
                                <button class="btn btn-md btn-xl--md u-btn-lightblue-v3 g-width-160--md g-font-size-12 g-font-size-default--md g-mb-10 g-mt-30 " type="submit ">Save Changes</button>
