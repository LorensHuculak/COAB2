        ...
        <div class="g-pa-20">
            ...
            <div class="media">
                <div class="d-flex align-self-center g-mt-10">
                    ...
                    <h1 class="g-font-weight-300 g-font-size-28 g-color-black mb-0">Edit Task</h1>
                </div>
            ...
            <form method="post" class="g-pa-30 g-pt-0">
                ...
                <div class="form-group g-mb-20">
                    ...
                    <input id="inputGroup1_1" class="form-control form-control-md rounded-4 g-color-gray-dark-v8" name="taskname" type="text" placeholder="<?php echo $details[0]['taskname']; ?>"> </div>
                ...
                <div class="form-group g-mb-20">
                    ...
                    <input id="inputGroup1_1" class="form-control form-control-md rounded-4 g-color-gray-dark-v8" name="message" type="text" placeholder="<?php echo $details[0]['message']; ?>"> </div>
