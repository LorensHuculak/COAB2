        ...
        <div class="g-pa-20">
            ...
            <div class="media">
                <div class="d-flex align-self-center g-mt-10">
                    ...
                    <h1 class="g-font-weight-300 g-font-size-28 g-color-black mb-0">Edit Bill</h1>
                </div>
            ...
            <form method="post" class="g-pa-30 g-pt-0">
                ...
                <div class="form-group g-mb-20">
                    ...
                    <input id="inputGroup1_1" class="form-control form-control-md rounded-4 g-color-gray-dark-v8" name="name" type="text" placeholder="<?php echo $details[0]['name']; ?>"> </div>
                ...
                <div class="form-group g-mb-20">
                    ...
                    <div class="input-group g-brd-primary--focus">
                        ...
                        <input name="price" class="form-control form-control-md border-left-0 rounded-4 pl-0 g-color-gray-dark-v8" type="text" placeholder="<?php echo $details[0]['price']; ?>">
                    </div>
                ...
                <div class="form-group g-mb-20">
                    ...
                    <input id="inputGroup1_1" class="form-control form-control-md rounded-4 g-color-gray-dark-v8" name="site" type="text" placeholder="<?php echo $details[0]['site']; ?>"> </div>


                <div class="form-group g-mb-20">

                    <label class="g-mb-10" for="inputGroup1_1">Upload Document</label>
                ...
                <button class="btn btn-md btn-xl--md u-btn-lightblue-v3 g-width-160--md g-font-size-12 g-font-size-default--md   g-mt-15" type="submit ">Add Bill</button>
