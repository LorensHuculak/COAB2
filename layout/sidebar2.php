<main class="container-fluid px-0 g-pt-65">
    <div class="row no-gutters g-pos-rel g-overflow-x-hidden">
      ...
      <i class="fa fa-comments-o"></i>
                        ...
                        <span class="media-body align-self-center">Communication</span>
      ...
      <i class="hs-admin-angle-right"></i>
                    ...
                    <ul id="subMenu1" class="u-sidebar-navigation-v1-menu u-side-nav--second-level-menu mb-0" style="display: block;">
                        ...
                        <li class="u-sidebar-navigation-v1-menu-item u-side-nav--second-level-menu-item">
                            <a class="media u-side-nav--second-level-menu-link g-px-15 g-py-12 " href="events.php">
                                <span class="d-flex align-self-center g-mr-15 g-mt-minus-1">
          <i class="fa fa-calendar"></i>
        </span>
                                <span class="media-body align-self-center">Events</span>
                            </a>
                        </li>
                        <!-- End Dashboards v1 -->
                        ...
                        <!-- Dashboards v2 -->
                        <li class="u-sidebar-navigation-v1-menu-item u-side-nav--second-level-menu-item">
                            <a class="media u-side-nav--second-level-menu-link g-px-15 g-py-12 active" href="tasks.php">
                                <span class="d-flex align-self-center g-mr-15 g-mt-minus-1">
          <i class="fa fa-list-ul"></i>
        </span>
                                <span class="media-body align-self-center">Tasks</span>
                            </a>
                        </li>
                        <!-- End Dashboards v2 -->
                        ...
                        <!-- Dashboards v3 -->
                        <li class="u-sidebar-navigation-v1-menu-item u-side-nav--second-level-menu-item">
                            <a class="media u-side-nav--second-level-menu-link g-px-15 g-py-12" href="voting.php">
                                <span class="d-flex align-self-center g-mr-15 g-mt-minus-1">
          <i class="fa fa-check"></i>
        </span>
                                <span class="media-body align-self-center">Voting</span>
                            </a>
                        </li>
                        <!-- End Dashboards v3 -->
      ...
      <i class="icon-finance-231 u-line-icon-pro"></i>
                        ...
                        <span class="media-body align-self-center">Finance</span>
                        <span class="d-flex align-self-center u-side-nav--control-icon">
      <i class="hs-admin-angle-right"></i>
    </span>
                        <span class="u-side-nav--has-sub-menu__indicator"></span>
                    ...
                    <ul id="subMenu2" class="u-sidebar-navigation-v1-menu u-side-nav--second-level-menu mb-0">
                        ...
                        <!-- Hide Sidebar -->
                        <li class="u-sidebar-navigation-v1-menu-item u-side-nav--second-level-menu-item">
                            <a class="media u-side-nav--second-level-menu-link g-px-15 g-py-12" href="bills.php">
                                <span class="d-flex align-self-center g-mr-15 g-mt-minus-1">
          <i class="fa fa-credit-card"></i>
        </span>
                                <span class="media-body align-self-center">Bills</span>
                            </a>
                        </li>
                        <!-- End Hide Sidebar -->

                        <li class="u-sidebar-navigation-v1-menu-item u-side-nav--second-level-menu-item">
                            <a class="media u-side-nav--second-level-menu-link g-px-15 g-py-12" href="energy.php">
                                <span class="d-flex align-self-center g-mr-15 g-mt-minus-1">
          <i class="fa fa-bolt"></i>
        </span>
                                <span class="media-body align-self-center">Energy</span>
                            </a>
                        </li>
